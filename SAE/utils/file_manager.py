...
#==============================================================================
    ...
    @staticmethod
    def readListItemsFromFile(path_file):
        str_content = FileManager.readStringFile(path_file)
        list_items = str_content.split("\n")

        list_items_filtered = [item for item in list_items if item != '']
        return list_items_filtered
    ...
    def listFilesRecursive(path_dir):
        ...
        for entry in listOfFile:
            ...
            if os.path.isdir(fullPath):
                list_files = list_files + FileManager.listFilesRecursive(fullPath)
            else:
