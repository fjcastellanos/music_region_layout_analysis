...
class GTRegion:
    ...
    def getSRCSample(self, src_image, sample_size=None):
        ...
        if (sample_size is not None):
            sample = ImageProcessing.redimAnyImage(sample, sample_size[0], sample_size[1])
...
class GTJSONReaderMuret:
    ...
    def getListBoundingBoxes(self, considered_classes):
        self.__i_integrity()
        list_bbox = []
    ...
    def __str__(self):
        self.__i_integrity()
        return self.filename + ":" + "[" + str(self.pages) +  "]"
...
# =============================================================================
    ...
    str_pathdir_root = "../../../databases/MURET"
    str_pathdir_json = str_pathdir_root + "/JSON"
    str_pathdir_src = str_pathdir_root + "/SRC"
